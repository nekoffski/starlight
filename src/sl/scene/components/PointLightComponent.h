...
struct PointLightComponent : ecs::Component {
    ...
    explicit PointLightComponent(math::Vec3 position = math::Vec3{0.0f, 0.0f, 0.0f},
                                 math::Vec3 color = core::color::white, float attenuationA = 0.05f,
                                 float attenuationB = 0.1f, float attenuationC = 0.3f)
        : position(position),
          color(color),
