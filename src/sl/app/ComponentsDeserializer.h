...
class ComponentsDeserializer {
    using DeserializerCallback = std::function<
        void(kc::json::Node&, ecs::Entity&, asset::AssetManager&, const std::unordered_map<std::string, std::string>&)>;
   ...
   public:
    ...
    void deserializeComponent(
        const std::string& name, kc::json::Node& componentDescription, ecs::Entity& entity,
