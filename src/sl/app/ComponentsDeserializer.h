...
private:
    static void deserializeDirectionalLightComponent(kc::json::Node& componentDescription,
        ecs::Entity& entity, asset::AssetManager& assetManager, const std::unordered_map<std::string, std::string>& assetsIdRedirections);

    static void deserializeMaterialComponent(kc::json::Node& componentDescription,
        ecs::Entity& entity, asset::AssetManager& assetManager, const std::unordered_map<std::string, std::string>& assetsIdRedirections);

    static void deserializeMeshRendererComponent(kc::json::Node& componentDescription,
        ecs::Entity& entity, asset::AssetManager& assetManager, const std::unordered_map<std::string, std::string>& assetsIdRedirections);

    static void deserializeModelComponent(kc::json::Node& componentDescription,
        ecs::Entity& entity, asset::AssetManager& assetManager, const std::unordered_map<std::string, std::string>& assetsIdRedirections);

    static void deserializeParticleEffectComponent(kc::json::Node& componentDescription,
        ecs::Entity& entity, asset::AssetManager& assetManager, const std::unordered_map<std::string, std::string>& assetsIdRedirections);

    static void deserializePointLightComponent(kc::json::Node& componentDescription,
        ecs::Entity& entity, asset::AssetManager& assetManager, const std::unordered_map<std::string, std::string>& assetsIdRedirections);

    static void deserializeTransformComponent(kc::json::Node& componentDescription,
        ecs::Entity& entity, asset::AssetManager& assetManager, const std::unordered_map<std::string, std::string>& assetsIdRedirections);

    static void deserializeRigidBodyComponent(kc::json::Node& componentDescription,
        ecs::Entity& entity, asset::AssetManager& assetManager, const std::unordered_map<std::string, std::string>& assetsIdRedirections);
