...
void CapturePointDepthMapsStage::execute(
    ...
    auto [meshRenderers, transforms, pointLights, models] = scene.ecsRegistry.getComponentsViews<
        MeshRendererComponent, TransformComponent, PointLightComponent, ModelComponent>();
...
std::array<math::Mat4, 6> CapturePointDepthMapsStage::calculateShadowTransforms(
    ...
    shadowTransforms[0] =
        m_shadowProjection *
        math::lookAt(
            lightPosition, lightPosition + math::Vec3(1.0, 0.0, 0.0), math::Vec3(0.0, -1.0, 0.0)
        );
    ...
    shadowTransforms[2] =
        m_shadowProjection *
        math::lookAt(
            lightPosition, lightPosition + math::Vec3(0.0, 1.0, 0.0), math::Vec3(0.0, 0.0, 1.0)
        );
    ...
    shadowTransforms[4] =
        m_shadowProjection *
        math::lookAt(
            lightPosition, lightPosition + math::Vec3(0.0, 0.0, 1.0), math::Vec3(0.0, -1.0, 0.0)
        );
