...
void OpenGlVertexArray::addVertexBuffer(std::shared_ptr<graphics::buffer::VertexBuffer> vertexBuffer) {
    this->bind();
    vertexBuffer->bind();
...
void OpenGlVertexArray::addElementBuffer(std::shared_ptr<graphics::buffer::ElementBuffer> elementBuffer) {
    this->bind();
    elementBuffer->bind();
