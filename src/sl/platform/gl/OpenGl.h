...
struct OpenGl : GPU {
    explicit OpenGl()
        : GPU(
              std::make_unique<OpenGlVertexArrayFactory>(),
              ...
              std::make_unique<OpenGlTextureFactory>(),
              std::make_unique<OpenGlCubemapFactory>(),
              std::make_unique<OpenGlShaderFactory>(),
              std::make_unique<OpenGlShaderCompiler>(),
