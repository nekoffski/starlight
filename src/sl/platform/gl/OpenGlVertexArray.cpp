...
void OpenGlVertexArray::addVertexBuffer(std::shared_ptr<sl::gpu::VertexBuffer> vertexBuffer) {
    this->bind();
    vertexBuffer->bind();
...
void OpenGlVertexArray::addElementBuffer(std::shared_ptr<sl::gpu::ElementBuffer> elementBuffer) {
    this->bind();
    elementBuffer->bind();
