...
Swapchain::Swapchain(Device* device, Context* context, const Size2u32& size)
...
VkExtent2D createSwapchainExtent(
    const Size2u32& viewportSize, const Device::SwapchainSupportInfo& swapchainSupport
) {
...
void Swapchain::changeSize(const Size2u32& size) {
    m_viewportSize = size;
