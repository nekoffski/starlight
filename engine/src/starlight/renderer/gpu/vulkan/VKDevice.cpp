...
// VKDevice::VKDevice(Allocator* allocator, VkInstance instance, VkSurfaceKHR
// surface) :
...
// std::vector<VkQueueFamilyProperties> getQueueFamilyProperties(VkPhysicalDevice
// device ) {
...
//     // Discrete GPU?
//     if (requirements.discreteGpu && properties.deviceType !=
//     VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU) {
//         LOG_INFO("VKDevice is not a discrete GPU, and one is required.
//         Skipping."); return {};
//     }
...
//     swapchainSupport.presentModes.size() < 1) {
...
// QueuesCreateInfo createQueuesCreateInfo(const std::vector<uint32_t>&
// queuesIndices) {
...
//     vulkanHandle.enabledExtensionCount   =
//     deviceCreateInfo.extensionsNames.size(); vulkanHandle.ppEnabledExtensionNames
//     = deviceCreateInfo.extensionsNames.data();
...
//       m_physicalDevice, &deviceCreateInfo.vulkanHandle, m_allocator,
//       &m_logicalDevice
//     ));
...
//     );
//     vkGetDeviceQueue(m_logicalDevice, m_queueIndices.present, 0,
//     &m_queues.present); vkGetDeviceQueue(
