...
void UIShader::createGlobalDescriptorSetLayout() {
...
void UIShader::createGlobalDescriptorPool(int swapchainImageCount) {
...
void UIShader::createLocalDescriptorPool() {
...
void UIShader::createLocalDescriptorSetLayout() {
...
void UIShader::createShaderStages() {
    m_stages.reserve(stagesCount);

    m_stages.emplace_back(
        m_device, m_context, ShaderStage::Properties{"UIShader", ShaderStage::Type::vertex}
    );

    m_stages.emplace_back(
        m_device, m_context, ShaderStage::Properties{"UIShader", ShaderStage::Type::fragment}
    );
}
...
void UIShader::updateGlobalWorldState(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
VkDescriptorSetLayout UIShader::getGlobalDescriptorSetLayout() const {
    return m_globalDescriptorSetLayout;
}

const std::vector<ShaderStage>& UIShader::getStages() const { return m_stages; }

UIShader::GlobalUBO& UIShader::getGlobalUBO() { return m_globalUBO; }

void UIShader::acquireResources(Material& material) {  // TODO: free list
...
void UIShader::releaseResources(Material& material) {
    auto& instanceState = m_instanceStates[material.internalId];
