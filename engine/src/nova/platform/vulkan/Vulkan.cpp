...
std::string getResultString(VkResult result, bool extended) {
    ...
    switch (result) {
        ...
        //    :"VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS A buffer creation or memory allocation
        //    failed because the requested address is not available. A shader group handle
        //    assignment failed because the requested shader group handle information is no longer
        //    valid.";
